...
# Form implementation generated from reading ui file 'removePosts.ui'
#
...
class Ui_remove_post(QDialog):
    def __init__(self, parent, data: str):
        super(Ui_remove_post, self).__init__(parent)
        self.user = data
        self.setupUi(self)

    def setupUi(self, remove_post):
        remove_post.setObjectName("remove_post")
        remove_post.resize(560, 438)
        remove_post.setStyleSheet("background:rgb(22, 33, 62)")
        self.verticalLayout = QtWidgets.QVBoxLayout(remove_post)
        self.verticalLayout.setObjectName("verticalLayout")
        self.user_table_tbl = QtWidgets.QTableWidget(remove_post)
        self.user_table_tbl.setStyleSheet("QTableWidget{\n"
                                          "background:rgb(255, 255, 255);\n"
                                          "border: 2px solid rgb(160, 132, 202);\n"
                                          "border-radius:5px;\n"
                                          "}")
        self.user_table_tbl.setEditTriggers(QtWidgets.QAbstractItemView.AllEditTriggers)
        ...
        self.user_table_tbl.horizontalHeader().setDefaultSectionSize(30)
        self.user_table_tbl.horizontalHeader().setMinimumSectionSize(30)
        self.user_table_tbl.horizontalHeader().setSortIndicatorShown(True)
        self.user_table_tbl.horizontalHeader().setStretchLastSection(True)
        self.user_table_tbl.verticalHeader().setVisible(False)
        self.user_table_tbl.verticalHeader().setCascadingSectionResizes(False)
        self.user_table_tbl.verticalHeader().setHighlightSections(False)
        self.user_table_tbl.verticalHeader().setSortIndicatorShown(False)
        self.user_table_tbl.verticalHeader().setStretchLastSection(False)
        self.verticalLayout.addWidget(self.user_table_tbl)
        self.widget = QtWidgets.QWidget(remove_post)
        ...
        self.select_all_btn.setStyleSheet("QPushButton { \n"
                                          ...
                                          "}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("images/selection.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.remove_btn.setStyleSheet("QPushButton { \n"
                                      ...
                                      "}")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("images/remove-user.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.save_btn.setStyleSheet("QPushButton { \n"
                                    ...
                                    "}")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("images/diskette.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.save_btn.setIcon(icon3)
        self.save_btn.setObjectName("save_btn")
        self.horizontalLayout.addWidget(self.save_btn)
        self.verticalLayout.addWidget(self.widget)

        self.retranslateUi(remove_post)
        QtCore.QMetaObject.connectSlotsByName(remove_post)
        self.load_data()
        self.setup_buttons()
    ...
    def load_data(self):
        try:
            ...
            for post in data[self.user]:
                ...
                self.user_table_tbl.setItem(row_index, 1, QtWidgets.QTableWidgetItem(post))
                # self.user_table_tbl.setItem(row_index, 2, QtWidgets.QTableWidgetItem('data'))
        except FileNotFoundError:
            pass
    ...
    def retranslateUi(self, remove_post):
        _translate = QtCore.QCoreApplication.translate
        remove_post.setWindowTitle(_translate("remove_post", "Remove Post"))
        self.user_table_tbl.setSortingEnabled(True)
        item = self.user_table_tbl.horizontalHeaderItem(0)
        item.setText(_translate("remove_post", "#"))
        item = self.user_table_tbl.horizontalHeaderItem(1)
        item.setText(_translate("remove_post", "Post"))
        self.select_all_btn.setText(_translate("remove_post", "Select All"))
        self.unselect_all_btn.setText(_translate("remove_post", "Unselect All"))
        self.remove_btn.setText(_translate("remove_post", "Remove"))
        self.save_btn.setText(_translate("remove_post", "Save"))
        self.user_table_tbl.setSortingEnabled(True)
